...
Invoke-WebRequest `
-Uri "https://raw.githubusercontent.com/ICTKBV/Vanhonsebrouck/refs/heads/main/RemoveBloat.ps1" `
...
$arguments = ' -customwhitelist "'Microsoft.OneDriveSync','Microsoft.MicrosoftOfficeHub'"
